...
namespace Complete
{
    public class TankShooting : MonoBehaviour
    {
        ...
        // Cooldown
        float timeLastShot = 0;                     // Tme since last shot
        [SerializeField] float cooldownTime = 0.5f; // Minimum time between shots
        ...
        private void Update()
        {
            ...
            // Checks that the shoit is allowed, the chick is done twice because the check within also works externally and this is left for debugging purposes
            if (timeLastShot >= cooldownTime)
            {
        ...
        public void Fire()
        {
            // Check if enough time have passed to allow a new shot
            if (timeLastShot >= cooldownTime)
            {
                timeLastShot = 0;
